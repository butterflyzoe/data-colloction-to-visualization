...
namelist = [0] * 120  # 游戏名称
firmlist = [0] * 120  # 厂商名称
scorelist = [0] * 120  # 游戏评分
categorylist = [0] * 120  # 游戏分类
taglist = [0] * 120  # 游戏标签
statisticslist = [0] * 120  # 数据(关注、下载、购买)
games = list()
...
class getpage1(threading.Thread):
    def run(self):
        ...
        driver01.get('https://www.taptap.com/top/ios')
        gettable(1, driver01)
...
class getpage2(threading.Thread):
    def run(self):
        ...
        driver02.get('https://www.taptap.com/top/ios')
        getpage(2, driver02)
        gettable(2, driver02)
...
class getpage3(threading.Thread):
    def run(self):
        ...
        driver03.get('https://www.taptap.com/top/ios')
        getpage(3, driver03)
        gettable(3, driver03)
...
class getpage4(threading.Thread):
    def run(self):
        ...
        driver04.get('https://www.taptap.com/top/ios')
        getpage(4, driver04)
        gettable(4, driver04)
...
if __name__=='__main__':
    ...
    test.to_csv('E:/TapTap/2021.1.6/IOS_Hot.csv', encoding="utf_8_sig", index=False)
